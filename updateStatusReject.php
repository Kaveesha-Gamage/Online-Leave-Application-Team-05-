...
if (!isset($_SESSION["sess_user"])) {
    ...
    // Prepare the SQL statement for updating the rejection reason
    $stmt2 = $conn->prepare("UPDATE leaves SET rejection_reason=? WHERE eid=? AND descr=?");
    $stmt2->bind_param("sss", $reason, $eid, $descr);
    $stmt2->execute();
